...
class AvatarCellTests: XCTestCase {
    ...
    func testConfigureImageConnected()
    {
        ...
        XCTAssertEqual(self.sut.imgView.image, AvatarDownloadTaskMock.defaultImage)
    }
    ...
    func testConfigureTitleConnected()
    {
        ...
        XCTAssertEqual(self.sut.textLabel.text, AvatarDownloadTaskMock.defaultAvatar.identifier)
    }
